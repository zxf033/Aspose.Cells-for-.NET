...
Workbook wb = new Workbook("sample.xlsx"); Worksheet ws = wb.Worksheets\["Sheet1"\]; CopyOptions co = new CopyOptions(); co.ExtendToAdjacentRange = true; Cells cells = ws.Cells; cells.CopyRows(cells, 0, 1, 1, co); 
